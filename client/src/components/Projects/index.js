...
class Projects extends Component {
  ...
  handleEditProject = () => {
    ...
    const { editProject, editProjectId, editProjectModal } = this.state;

    editProjectRequest(editProjectId, editProject);
  ...
  handleModalEditProject = ({ id, name} ) => {
  ...
  render() {
    ...
    const { newProject, editTeam, editTeamModal, editProjectModal, editProject, editProjectId } = this.state;
    ...
    return (
      <Container>
        <header>
          ...
          <div>
            <MdModeEdit
              onClick={this.handleModalEditTeam}
              size={22}
              color="#fff"
            />
            <MdDelete
              onClick={() => this.handleDeleteTeam(activeTeam.id)}
              size={22}
              color="#fff"
            />
          </div>
        ...
        {projects.data.map(project => (
          <Project key={project.id}>
            ...
            <div>
              <MdModeEdit
                onClick={ () => this.handleModalEditProject(project)}
                size={22}
                color="#fff"
              />
              <MdDelete
        ...
        {editTeamModal && (
          <Modal>
            ...
            <form>
              ...
              />
              <Button
                onClick={() => this.handleEditTeam(activeTeam.id)}
                size="big"
                type="submit"
              >
                Salvar
        ...
        {editProjectModal && (
          <Modal>
            ...
            <form>
              ...
              <Button
                onClick={this.closeModalProject}
                size="small"
                color="gray"
                type="submit"
              >
...
const mapDispatchToProps = dispatch =>
  bindActionCreators(
    { ...ProjectsAction, ...MembersAction, ...TeamsAction },
    dispatch
  );
